class Utilisateur:
    ...
    def __init__(self, nom):
        ...
        """
        self.nom = nom
        self.livres_empruntés = []  # L'utilisateur commence avec zéro livre emprunté.
    ...
    def retourner_livre(self, livre):
        ...
        """
        if livre in self.livres_empruntés:
            self.livres_empruntés.remove(
                livre
